    ...
    public partial class frmMsMail : Form
    {
        ...
        private Boolean fDataCheck()
        {
            try
            {
                ...
                // 送信先メールアドレス
                if (txtToAddress.Text.Trim().Length < 1)
                {
                    txtToAddress.Focus();
                    throw new Exception("出勤簿の送信先メールアドレスを入力してください");
                }
