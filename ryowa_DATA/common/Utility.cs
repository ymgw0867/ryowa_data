...
namespace ryowa_DATA.common
{
    class Utility
    {
        ...
        ///     true </returns>
        ///-----------------------------------------------------------------------------------
        public static bool getHolTime(ryowaDataSet.T_勤怠DataTable tbl, out int hol, out int hotei, int pID, int sYY, int sMM, int sNum)
        {
            var ff = tbl
        ...
        ///     true </returns>
        ///-----------------------------------------------------------------------------------
        public static bool getHolTime(ryowaDataSet.T_勤怠DataTable tbl, out int hol, out int hotei, int sYY, int sMM, int sNum)
        {
            var ff = tbl
