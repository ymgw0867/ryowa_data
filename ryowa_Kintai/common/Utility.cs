    ...
    class Utility
    {
        ...
        public class comboKouji
        {
            ...
            public static void Load(ComboBox tempBox)
            {
                ...
                kintaiDataSetTableAdapters.M_工事TableAdapter adp = new kintaiDataSetTableAdapters.M_工事TableAdapter();
                adp.Fill(dts.M_工事);
        ...
        ///     true </returns>
        ///-----------------------------------------------------------------------------------
        public static bool getHolTime(kintaiDataSet.T_勤怠DataTable tbl, out int hol, out int hotei, int pID, int sYY, int sMM, int sNum)
        {
            var ff = tbl
        ...
        ///     true </returns>
        ///-----------------------------------------------------------------------------------
        public static bool getHolTime(kintaiDataSet.T_勤怠DataTable tbl, out int hol, out int hotei, int sYY, int sMM, int sNum)
        {
            var ff = tbl
        ...
        ///     工事コード</param>
        ///----------------------------------------------------------------------------
        public static void getdaikyuTime(kintaiDataSet dts, out int holDTM, out int houteiDTM, int sYY, int sMM, int sNum, int pID)
        {
            holDTM = 0;
            houteiDTM = 0;
        ...
        ///     休日勤務時間・分</returns>
        ///------------------------------------------------------------------
        private static int getHolWorkTime(kintaiDataSet dts, DateTime dt, int sNum)
        {
