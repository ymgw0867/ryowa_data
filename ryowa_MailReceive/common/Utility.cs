...
namespace ryowa_MailReceive.common
{
    class Utility
    {
        ...
        ///     true </returns>
        ///-----------------------------------------------------------------------------------
        public static bool getHolTime(mailReceiveDataSet.T_勤怠DataTable tbl, out int hol, out int hotei, int pID, int sYY, int sMM, int sNum)
        {
            var ff = tbl
        ...
        ///     勤務時間・分</returns>
        ///-----------------------------------------------------------------------------
        public static double getWorkTime(mailReceiveDataSet.T_勤怠Row item)
        {
