...
namespace ryowa_MailReceive.common
{
    class global
    {
        ...
        // 出勤簿ＣＳＶデータの検証要素
        public const int CSVLENGTH = 37;            // 出勤簿更新データフィールド数
        public const int CSVLENGTH_req = 4;         // 出勤簿要求データフィールド数
        public const int CSVLENGTH_chk = 3;         // 確認送信データフィールド数
        ...
        // メール種類別タイトル
        public const string TIMECARD = "timecard";          // 出勤簿更新メール
        public const string DATAREQUEST = "datarequest";    // 部下勤怠リクエスト
        public const string CHECKEDDATA = "dataChecked";    // 確認送信メール
    }
}
